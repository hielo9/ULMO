...
struct SimParams
{
    ...
    // THESE NEED TO BE THE SAME AS THE VALUES FOR numCells.x,.y,.z in particles.cpp
	#define NUM_CELLS_X 40 //47	 //24 //29
    #define NUM_CELLS_Y 40 //47	 //24 //29
	#define NUM_CELLS_Z 40 //160 //188 //95 //88
